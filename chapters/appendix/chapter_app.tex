...
\labe\{section:N1_backup}
The following section contains N-1 plots in the ``merged" signal region, with the inlcusion of the single highly negatively weighted event excluded in \ref{section:sr_merged} for comparison.
\begin{figure}[htbp]
  \centering
