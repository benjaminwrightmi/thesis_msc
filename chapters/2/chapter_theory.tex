...
\begin{figure}[h]
    ...
    \caption{The elementary particles of the Standard Model \cite{sm_photo}.}
...
A Higgs field $\Phi$ is introduced, with a Lagrangian which can be written as:
\begin{equation}
...
\begin{figure}[h]
    ...
    \caption{Shapes of the Higgs potential for different cases of $\mu^2$. \cite{HiggsPot}}
    \label{fig:higgspot}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{The bullet cluster showing separation of x-ray density (pink) and gravitational density (blue) \cite{chandra}.}
    \label{fig:bullet}
\end{figure}
