\newcommand\thesistitle{Search for dark Higgs boson production in $pp$ events at $\sqrt{s}$ = 13 TeV with the ATLAS detector at the LHC}
% One needs to make adjustments for a Master's Thesis
\newcommand\nameanddegrees{%
Benjamin Wright\\
B.Sc., Queen's University, 2019}
\newcommand\panel{%
\HRule\\\panelist{Dr. J.\ Albert}{Supervisor}{Department of Physics and Astronomy}
\HRule\\\panelist{Dr. R.\ Sobie}{Departmental Member}{Department of Physics and Astronomy}}
